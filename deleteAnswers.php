...
include('session.php');
    ...
    if(isset($_GET['post_id']) && isset($_GET['u_id'])){
        ...
        $delete_user_query = "DELETE FROM answersposts WHERE u_id = ".$_GET['u_id']." and answer_id = ".$_GET['answer_id']." and post_id = ".$_GET['post_id'];
        
        if (mysqli_query($db, $delete_user_query)) {
            array_push($success, "Your answer is deleted.");
