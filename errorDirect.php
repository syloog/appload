    ...
    <main class="page contact-page">
        <section class="portfolio-block contact">
            <div class="container" style="padding: 50px;">
                <h1 class="text-center">Ups... Something went wrong.</h1>
                <p class="text-center">To be able to see some content, you have to register.<br>If you have an account, go to login page.<br></p>
            </div>
            <div class="container d-xl-flex justify-content-xl-center"><a href="loginScreen.php"><button class="button" type="button" data-hover="LET'S GO!"><span>LOGIN</span></button></a></div>
            </div>
            <div class="container d-xl-flex justify-content-xl-center"><a href="register.php"><button class="button" type="button" data-hover="CLICK ME!"><span>WANNA REGISTER?</span></button></a></div>
        </section>
    </main>
