           ...
           <form action="updateApp.php" method=post enctype="multipart/form-data">
            <div class="container" id="info-container">
               <!--<form action="updateApp.php" method=post>-->
                    <div class="row">
                        <div class="col-auto col-md-12" style="padding-bottom: 25px;padding-top: 25px;">
                            <h2 class="text-center text-info">Application Update Form</h2>
                        </div>
                        <div class="col" id="contact-box" style="padding-top: 0px;padding-left: 0px;padding-bottom: 0px;">
                            <div class="row">
                                <div class="col d-xl-flex justify-content-xl-center item zoom-on-hover" style="background-color: rgb(255,255,255);">
                                  <img class="img-fluid image" src="./images/application_photos/<?php  $app_id = $_GET["app_id"];
                                    $app_id = $app_id +0;
                    ...
                    <div>
                     ...
                     <fieldset id="cpuField">
                        ...
                        <div class="row" style="padding: 34px;">
                            <div class="col"><button class="button" type="submit" name="continue" value=<?php $app_id = $_GET["app_id"]; echo $app_id; ?>  data-hover="CONFIRM ?"><span>SEND REQUEST</span></button></div>
                        </div>
                    </div>
            <!--    </form>-->
            </div>
